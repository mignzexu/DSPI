...
class CARPK(Dataset):
    def __init__(self, data_dir:str, split:str, subset_scale:float=1.0, resize_val:bool=True, args=None):
        """
        Parameters
        ----------
        ...
        self.args = args
        #!HARDCODED Dec 25: 
        self.data_dir = f"{self.args.data_path}/CARPK/"
...
class GCARPK(CARPK):
    ...
    def __getitem__(self, idx):
        ...
        im_id = self.idx_running_set[idx] + ".png"
