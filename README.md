...
```
**Apptainer:** Create a apptainer environment, and install all dependencies.
```
apptainer build /scratch/pytorch_23.02-py3-clipcount.sif clipcount_env.def 
apptainer exec --nv --bind /scratch:/scratch --bind /shares:/shares /scratch/pytorch_23.02-py3-clipcount.sif bash -c "cd /home/wenzhe/Experiments/heu/CLIP-Count && bash scripts/train.sh"
```
...
```
cd data/FSC/FSC_147/
mv annotation_FSC147_384.json annotation_FSC_147_384.json
mv ImageClasses_FSC147.txt ImageClasses_FSC_147.txt
```
## Run the Code
